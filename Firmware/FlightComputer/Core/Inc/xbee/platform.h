...
#elif defined(STM32F103xB) || defined(STM32F405xx) || defined(STM32F407xx) || defined(STM32H7xx) || \
      defined(STM32L4xx) || defined(STM32F1xx) || defined(STM32F4xx)
   #include "../ports/stm32/platform_config.h"
#else
...
/**
   ...
   OK for this counter to rollover
   .  Used for timing and should have a
