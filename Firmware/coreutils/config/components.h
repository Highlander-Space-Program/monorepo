...
ServoConfig servo_lookup_table[] = {
	{{0x00390043, 0x48585311, 0x20373733}, 0x02010108, "FV-N02", 85, 200, -1},
	{{0x0032002D, 0x48585314, 0x20373733}, 0x02020108, "FV-N03", 85, 200, -1},
	{{0x00310043, 0x48585311, 0x20373733}, 0x02030108, "FV-N04", 85, 200, -1},
...
// BoardID, CAN_ID, NAME, FREQUENCY, GAIN, min_val, max_val, OFFSET
PtConfig pt_lookup_table[] = {
	{{0x002b002c, 0x48585314, 0x20373733}, 0x00110308, "PT-01", 100, 0, 100, 0, 1000, 'A'},
	{{0x002b002c, 0x48585314, 0x20373733}, 0x00110310, "PT-02", 100, 0, 100, 0, 1000, 'B'},
	{{0x0032001e, 0x46304317, 0x200003e0}, 0x00120308, "PT-03", 100, 0, 100, 0, 1000, 'B'},
	{{0x0032001e, 0x46304317, 0x200003e0}, 0x00110310, "PT-04", 100, 0, 100, 0, 1000, 'A'}
