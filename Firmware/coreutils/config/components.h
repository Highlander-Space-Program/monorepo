...
ServoConfig servo_lookup_table[] = {
	...
	{{0x0035002c, 0x48585314, 0x20373733}, 0x02030108, "FV-N04", 200, 85, -1},
...
ThermoConfig thermo_lookup_table[] = {
	...
	{{0x0035002c, 0x48585314, 0x20373733}, 0x02030208, "TC-04", 2},
...
HeaterConfig heater_lookup_table[] = {
	...
	{{0x0035002c, 0x48585314, 0x20373733}, 0x02030408, "H-04", 29, 27, 100},
...
PtConfig pt_lookup_table[] = {
	{{0x002b002c, 0x48585314, 0x20373733}, 0x03110308, "PT-01", 8, 1, 0, 0, 1600, 'A'},
	{{0x002b002c, 0x48585314, 0x20373733}, 0x03110310, "PT-02", 8, 1, 0, 0, 1000, 'B'},
	{{0x003a003b, 0x32305305, 0x31333246}, 0x03120308, "PT-03", 8, 1, 0, 0, 1000, 'B'},
	{{0x003a003b, 0x32305305, 0x31333246}, 0x03120310, "PT-04", 8, 1, 0, 0, 1000, 'A'},
	{{0x003e003a, 0x32305305, 0x31333246}, 0x03130308, "PT-05", 8, 1, 0, 0, 1000, 'A'},
	{{0x003e003a, 0x32305305, 0x31333246}, 0x03130310, "PT-06", 8, 1, 0, 0, 1000, 'B'},
};

//AccelConfig barometer_lookup_table[] = {
//	{{0x0025003e, 0x3034510d, 0x37363432}, 0x06210701, "AM-01", 10, 1, 0, 0, 1000, 'B'},
//};
//
//GyroConfig barometer_lookup_table[] = {
//	{{0x0025003e, 0x3034510d, 0x37363432}, 0x06210801, "GM-01", 10, 1, 0, 0, 1000, 'B'},
//};
//
//BarometerConfig barometer_lookup_table[] = {
//	{{0x0025003e, 0x3034510d, 0x37363432}, 0x06210901, "BM-01", 100, 1, 0, 0, 1000, 'B'},
//};
...
BoardConfig board_lookup_table[] = {
	...
	{{0x0035002c, 0x48585314, 0x20373733}, 0x03, "MICHELANGELO", "FV-NO4"},
	{{0x003a0042, 0x48585311, 0x20373733}, 0x04, "RAPHAEL", "FV-PYRO"},
	{{0x002b002c, 0x48585314, 0x20373733}, 0x11, "SPLINTER", "SENSOR-1"},
	{{0x003a003b, 0x32305305, 0x31333246}, 0x12, "APRIL", "SENSOR-2"},
	{{0x003e003a, 0x32305305, 0x31333246}, 0x13, "BAXTER", "SENSOR-3"},
	{{0x0042003d, 0x3034510d, 0x37363432}, 0x20, "CASEY", "PC-01"},
	{{0x0025003e, 0x3034510d, 0x37363432}, 0x21, "SHREDDER", "FC-01"}
};
//{0x003c0032, 0x32305305, 0x31333246}
//{0x0035002c, 0x48585314, 0x20373733}
//{0x002b002c, 0x48585314, 0x20373733}
//Name : board_id[0]
//	Details:2818092
//	Default:2818092
//	Decimal:2818092
//	Hex:0x2b002c
//	Binary:1010110000000000101100
//	Octal:012600054
//
//Name : board_id[1]
//	Details:1213747988
...
//	Decimal:1213747988
//	Hex:0x48585314
//	Binary:1001000010110000101001100010100
//	Octal:011026051424
//
//Name : board_id[2]
//	Details:540489523
...
//	Decimal:540489523
//	Hex:0x20373733
//	Binary:100000001101110011011100110011
//	Octal:04015633463
